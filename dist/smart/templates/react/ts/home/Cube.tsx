 ...
 const logoPng = new URL('assets/images/smart.logo.png', import.meta.url);

 const percent = 90 / 400;

 export default function Cube() {
 const wrapperRef = useRef<HTMLDivElement>(null);
 const prePositionRef = useRef<{preX: number; preY: number}>({preX: 0, preY: 0});
 ...
 const target: HTMLDivElement = wrapperRef.current;
